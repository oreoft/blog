...
上篇简单总结了函数式接口，这篇给大家介绍最近让我为之着迷的**java函数编程库-vavr**.有一点要注意，函数式接口是vavr的基础，所以vavr最低支持的版本是java8。使用vavr可以有效减少代码量并且提升代码的优雅程度。一方面可以弥补java8自带函数式API的不完备和友好，另外一方面可以节省你自己造轮子的工作。

初闻vavr，感觉很奇怪，咋这个名字，后面看到它的[官网](https://www.vavr.io/)我沉默了，怀疑初创团队付费资讯了UC震惊部如何取名字，好家伙，vavr就是java这四个字倒过来，真的是'颠覆了'java.....
