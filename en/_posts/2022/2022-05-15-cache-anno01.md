---
layout: post
title: Data automatic caching annotations
excerpt: Automatic cache annotation based on Spring AOP
category: java
...
3. It can automatically cache non-existent data to prevent cache penetration under concurrency
4. Automatic mutex lock can be enabled when acquiring cache to prevent cache breakdown and protect DB
...
**For all version queries click [HERE](https://mvnrepository.com/artifact/cn.someget/cache-anno)** [**HERE**](https://mvnrepository.com/artifact/cn.someget/cache-anno) [**HERE**](https://mvnrepository.com/artifact/cn.someget/cache-anno)
...
2. There are already good solutions to prevent cache breakdown, and the next version will merge
